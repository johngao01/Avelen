...
class ABogus:
    ...
    def generate_string_2_list(
        ...
        ua_code = [76, 98, 15, 131, 97, 245, 224, 133, 122, 199, 241, 166, 79, 34, 90, 191, 128, 126, 122, 98, 66, 11,
                   14, 40, 49, 110, 110, 173, 67, 96, 138, 252]
        return self.list_4(
            (end_time >> 24) & 255,
            params_array[21],
            ua_code[23],
...
def ab_model_2_endpoint(params: dict, user_agent: str) -> str:
    if not isinstance(params, dict):
        raise TypeError("参数必须是字典类型")
    try:
        ab_value = ABogus().get_value(params, user_agent)
    except Exception as e:
